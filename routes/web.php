...
use App\Http\Controllers\Admin\AdminBayarController;
use App\Http\Controllers\Admin\AdminDatewiseRoomController;
use App\Http\Controllers\Admin\AdminDatewiseGedungController;

use App\Http\Controllers\Customer\CustomerHomeController;
use App\Http\Controllers\Customer\CustomerAuthController;
use App\Http\Controllers\Customer\CustomerProfileController;
use App\Http\Controllers\Customer\CustomerOrderController;
use App\Http\Controllers\Customer\CustomerDatewiseRoomController;
use App\Http\Controllers\Customer\CustomerDatewiseGedungController;
...
Route::get('/gedung', [Gedungontroller::class, 'index'])->name('gedung');
Route::get('/gedung/{id}', [GedungController::class, 'single_gedung'])->name('gedung_detail');
Route::post('/booking/submit', [BookingController::class, 'cart_submit'])->name('cart_submit');
Route::post('/sewa/submit', [SewaController::class, 'sewa_submit'])->name('sewa_submit');
...
Route::get('/sewa', [SewaController::class, 'sewa_view'])->name('sewa');
Route::get('/sewa/delete/{id}', [SewaController::class, 'sewa_delete'])->name('sewa_delete');
...
Route::post('/bayar', [SewaController::class, 'bayar'])->name('bayar');
...
Route::post('/bukti',[SewaController::class, 'bukti'])->name('bukti');
...
Route::post('/bayar/stripe/{price}', [SewaController::class, 'stripe'])->name('stripe');
Route::post('/bayar/midtrans/callback', [SewaController::class, 'callback'])->name('callback');
...
Route::group(['middleware' =>['customer:customer']], function(){
    ...
    Route::get('/customer/datewise-rooms', [CustomerDatewiseRoomController::class, 'index'])->name('customer_datewise_rooms');
    Route::post('/customer/datewise-rooms/submit', [CustomerDatewiseRoomController::class, 'show'])->name('customer_datewise_rooms_submit');
    Route::get('/customer/datewise-gedung', [CustomerDatewiseGedungController::class, 'index'])->name('customer_datewise_gedung');
    Route::post('/customer/datewise-gedung/submit', [CustomerDatewiseGedungController::class, 'show'])->name('customer_datewise_gedung_submit');
});
...
Route::group(['middleware' =>['admin:admin']], function(){
    ...
    Route::get('/admin/datewise-gedung', [AdminDatewiseGedungController::class, 'index'])->name('admin_datewise_gedung');
    Route::post('/admin/datewise-gedung/submit', [AdminDatewiseGedungController::class, 'show'])->name('admin_datewise_gedung_submit');
    ...
    Route::get('/admin/order/cetak', [AdminOrderController::class, 'cetak'])->name('admin_cetak');
    ...
    Route::get('/admin/bayar/view', [AdminBayarController::class, 'index'])->name('admin_bayars');
    Route::get('/admin/bayar/cetak', [AdminBayarController::class, 'cetak'])->name('admin_cetak');
    Route::get('/admin/bayar/status/{id}', [AdminBayarController::class, 'status'])->name('admin_status');
    Route::get('/admin/bayar/status/edit/{id}', [AdminBayarController::class, 'status_edit'])->name('admin_status_edit');
    Route::post('/admin/bayar/status/update', [AdminBayarController::class, 'status_update'])->name('admin_status_update');
    Route::get('/admin/bayar/delete/{id}', [AdminBayarController::class, 'delete'])->name('admin_status_delete');
    ...
    Route::get('/admin/gedung/view', [AdminGedungController::class, 'index'])->name('admin_gedung_view');
    Route::get('/admin/gedung/add', [AdminGedungController::class, 'add'])->name('admin_gedung_add');
    Route::post('/admin/gedung/store', [AdminGedungController::class, 'store'])->name('admin_gedung_store');
    Route::get('/admin/gedung/edit/{id}', [AdminGedungController::class, 'edit'])->name('admin_gedung_edit');
    Route::post('/admin/gedung/update/{id}', [AdminGedungController::class, 'update'])->name('admin_gedung_update');
    Route::get('/admin/gedung/delete/{id}', [AdminGedungController::class, 'delete'])->name('admin_gedung_delete');
    ...
    Route::get('/admin/gedung/gallery/{id}', [AdminGedungController::class, 'gallery'])->name('admin_gedung_gallery');
    Route::post('/admin/gedung/gallery/store/{id}', [AdminGedungController::class, 'gallery_store'])->name('admin_gedung_gallery_store');
    Route::get('/admin/gedung/gallery/delete/{id}', [AdminGedungController::class, 'gallery_delete'])->name('admin_gedung_gallery_delete');
