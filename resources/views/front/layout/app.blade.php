...
<html lang="en">
    <head>
        ...
        <title>Website Hotmer Madiun </title>
    ...
    <body>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 right-side">
                        <ul class="right">
                            ...
                            @if($global_page_data->cart_status == 1)
                            <li class="menu"><a href="{{ route('sewa') }}" style="color:white !important;">{{ $global_page_data->privacy_heading }} @if(session()->has('sewa_gedung_id'))<sup>{{ count(session()->get('sewa_gedung_id')) }}</sup>@endif</a></li>
                            @endif
                            ...
                            @else
                                ...
                                <li class="menu"><a href="{{ route('customer_home') }}" style="color:white !important;">Akun</a></li>
        ...
        <div class="navbar-area" id="stickymenu">
            ...
            <div class="main-nav" style="background-color:#001C30">
                <div class="container" style="background-color:#001C30">
                    <nav class="navbar navbar-expand-md navbar-light">
                        ...
                        <div class="collapse navbar-collapse mean-menu" id="navbarSupportedContent">
                            <ul class="navbar-nav ml-auto">
                                ...
                                <li class="nav-item">
                                    <a href="{{ route('about') }}" class="nav-link" style="color: white;">{{ $global_page_data->about_heading }}</a>
                                </li>
                                @endif

                                <li class="nav-item">
                                    <a href="javascript:void;" class="nav-link dropdown-toggle" style="color: white;">Kamar</a>
                                ...
                                <li class="nav-item">
                                    <a href="javascript:void;" class="nav-link dropdown-toggle" style="color: white;">Gedung</a>
                                    <ul class="dropdown-menu">
                                        @foreach($global_gedung_data as $item)
                                        <li class="nav-item">
                                            <a href="{{ route('gedung_detail',$item->id) }}" class="nav-link">{{ $item->name }}</a>
                                        </li>
                                        @endforeach
                                    </ul>
                                </li>
                                ...
                                <li class="nav-item">
                                    <a href="javascript:void;" class="nav-link dropdown-toggle" style="color: white;">Galeri</a>
                                    <ul class="dropdown-menu">
                                ...
                                <li class="nav-item">
                                    <a href="{{ route('blog') }}" class="nav-link" style="color: white;">{{ $global_page_data->blog_heading }}</a>
                                </li>
                                @endif

                                @if($global_page_data->contact_status == 1)
                                <li class="nav-item">
                                    <a href="{{ route('contact') }}" class="nav-link" style="color: white;">{{ $global_page_data->contact_heading }}</a>
                                </li>
                                @endif
                    ...
                    <div class="col-md-3">
                        <div class="item">
                            <form action="{{ route('subscriber_send_email') }}" method="post" class="form_subscribe_ajax">
                                ...
                                <div class="form-group">
                                    <input type="submit" class="btn btn-dark" style="background-color: #000000 !important;" value="Subscribe Now">
                                </div>
                            </form>
                        </div>
                    </div>
