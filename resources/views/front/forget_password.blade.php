            ...
            <div class="col-4">
                ...
                <form action="{{ route('customer_forget_password_submit') }}" method="post">
                    ...
                    <div class="login-form">
                        ...
                        <div class="mb-3">
                            <button type="submit" class="btn btn-primary bg-website"><font color="white">Pilih</button>
                            <a href="{{ route('customer_login') }}" class="primary-color"><font color="white">Kembali Halaman Login</a>
                        </div>
                    </div>
                </form>
