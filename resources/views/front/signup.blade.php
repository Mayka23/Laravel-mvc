            ...
            <div class="col-4">
                <form action="{{ route('customer_signup_submit') }}" method="post">
                    ...
                    <div class="login-form">
                        <div class="mb-3">
                            <label for="" class="form-label"><font color="white">Nama Lengkap</label>
                        ...
                        <div class="mb-3">
                            <label for="" class="form-label"><font color="white">Confirm Password</label>
                        ...
                        <div class="mb-3">
                            <button type="submit" class="btn btn-primary bg-website">Daftar</button>
                        </div>
                        <div class="mb-3">
                            <a href="{{ route('customer_login') }}" class="primary-color"><font color="white">Sudah Punya Akun? Login Sekarang</a>
                        </div>
                    </div>
                </form>
            </div>
