        ...
        <div class="row">
            <div class="col-lg-4 col-md-4 checkout-left mb_30">
                ...
                @endphp
                    <div class="mt_20">
                        ...
                        <span class="mt_20">Silahkan Untuk Upload Bukti Pembayaran</span>
            ...
            <div class="col-lg-4 col-md-4 checkout-right">
                <div class="inner">
                    ...
                    <div>
                        Negara: {{ session()->get('billing_country') }}
                    </div>
                    <div>
                        Alamat: {{ session()->get('billing_address') }}
                    </div>
                    <div>
                        Kota: {{ session()->get('billing_state') }}
                    </div>
                    <div>
                        Tanggal Lahir: {{ session()->get('billing_city') }}
                    </div>
                    <div>
                        No KTP: {{ session()->get('billing_zip') }}
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-4 checkout-right">
