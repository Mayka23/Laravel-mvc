...
<div class="section-body">
    <div class="invoice">
        <div class="invoice-print">
            ...
            <div class="row mt-4">
                <div class="col-md-12">
                    <div class="section-title">Pembayaran Selesai</div>
                    <p class="section-lead">Silahkan Menikmati Hotel Kami:</p>
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped table-hover table-md">
                            <tr>
                                ...
                                <th class="text-center">Mulai Acara</th>
                                <th class="text-center">Selesai Acara</th>
                            ...
                            @php
                            $gedung_data = \App\Models\Gedung::where('id',$item->gedung_id)->first();
                            @endphp
                            <tr>
                                <td>{{ $loop->iteration }}</td>
                                <td>{{ $gedung_data->name }}</td>
