<div class="main-sidebar">
    <aside id="sidebar-wrapper">
        <div class="sidebar-brand">
            <a href="{{ route('admin_home') }}">Halaman Admin</a>
        </div>
        ...
        <ul class="sidebar-menu">
            ...
            <li class="nav-item dropdown {{ Request::is('admin/amenity/view')||Request::is('admin/room/view')||Request::is('admin/gedung/view') ? 'active' : '' }}">
                <a href="#" class="nav-link has-dropdown"><i class="fa fa-superpowers"></i><span>Pilih Fasilitas</span></a>
                <ul class="dropdown-menu">
                    ...
                    <li class="{{ Request::is('admin/gedung/view') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin_gedung_view') }}"><i class="fa fa-angle-right"></i> Gedung</a></li>
                </ul>
            </li>

            <li class="nav-item dropdown {{ Request::is('admin/datewise-rooms')||Request::is('admin/datewise-gedung') ? 'active' : '' }}">
                <a href="#" class="nav-link has-dropdown"><i class="fa fa-calendar"></i><span>Ketersediaan Fasilitas</span></a>
                <ul class="dropdown-menu">
                    <li class="{{ Request::is('admin/datewise-rooms') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin_datewise_rooms') }}" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-title="Datewise Rooms"><i class="fa fa-angle-right"></i> <span> Cek Kamar</span></a></li>
                    <li class="{{ Request::is('admin/datewise-gedung') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin_datewise_gedung') }}" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-title="Datewise Gedung"><i class="fa fa-angle-right"></i> <span> Cek Gedung</span></a></li>
                </ul>
            </li>
            ...
            <li class="nav-item dropdown {{ Request::is('admin/order/*') || Request::is('admin/bayar/*') ? 'active' : '' }}">
                <a href="#" class="nav-link has-dropdown"><i class="fa fa-cart-plus"></i><span>Pilih Transaksi</span></a>
                <ul class="dropdown-menu">
                    <li class="{{ Request::is('admin/order/*') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin_orders') }}" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-title="Orders"><i class="fa fa-angle-right"></i> <span>Transaksi Kamar</span></a></li>
                    <li class="{{ Request::is('admin/bayar/*') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin_bayars') }}" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-title="Orders"><i class="fa fa-angle-right"></i> <span>Transaksi Gedung</span></a></li>
                </ul>
            </li>
            ...
            <li class="{{ Request::is('admin/testimonial/*') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin_testimonial_view') }}" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-title="Testimonial"><i class="fa fa-briefcase"></i> <span>Testimoni</span></a></li>

            <li class="{{ Request::is('admin/post/*') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin_post_view') }}" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-title="Post"><i class="fa fa-clipboard"></i> <span>Blog</span></a></li>
<!-- 
            ...
            <li class="{{ Request::is('admin/faq/*') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin_faq_view') }}" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-title="FAQ"><i class="fa fa-file"></i> <span>Laporan</span></a></li>
