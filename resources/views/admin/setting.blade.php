                    ...
                    <form action="{{ route('admin_setting_update',$setting_data->id) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="mb-4">
                                    <label class="form-label">Home Gedung Total</label>
                                    <input type="text" class="form-control" name="home_gedung_total" value="{{ $setting_data->home_gedung_total }}">
                                </div>

                                <div class="mb-4">
                                    <label class="form-label">Home Gedung Status</label>
                                    <select name="home_gedung_status" class="form-control">
                                        <option value="Show" @if($setting_data->home_gedung_status == 'Show') selected @endif>Show</option>
                                        <option value="Hide" @if($setting_data->home_gedung_status == 'Hide') selected @endif>Hide</option>
                                    </select>
                                </div>
