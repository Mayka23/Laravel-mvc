...
class AdminHomeController extends Controller
{
    public function index()
    {
        ...
        $bayars = Bayar::orderBy('id','desc')->skip(0)->take(5)->get();

        return view('admin.home', compact('total_completed_orders','total_pending_orders','total_active_customers','total_pending_customers','total_rooms','total_gedung','total_subscribers','orders','bayars'));
    }
}
