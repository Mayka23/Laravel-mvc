...
class BookingController extends Controller
{
    ...
    public function cart_submit(Request $request)
    {
        ...
        if($cnt == 0) {
            return redirect()->back()->with('error', 'Kamar Penuh');
        }
        ...
        return redirect()->back()->with('success', 'Kamar Telah Berhasil Ditambahkan Di Menu Checkout');
    }
    ...
    public function cart_delete($id)
    {
        ...
        return redirect()->back()->with('success', 'Checkout Telah Dihapus');
    ...
    public function checkout()
    {
        if(!Auth::guard('customer')->check()) {
            return redirect()->back()->with('error', 'Diharuskan Login Terlebiuh Dahulu Jika Ingin Transaksi');
        }

        if(!session()->has('cart_room_id')) {
            return redirect()->back()->with('error', 'Tidak Ada Item Di Checkout');
        }
